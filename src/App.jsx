...
const StatisticsDashboard = ({ games }) => {
  ...
  return (
    <div className="relative z-20 mb-8 px-6 py-3 rounded-xl border backdrop-blur-md transition-all duration-500 bg-zinc-900/40 border-white/10 flex items-center justify-center gap-16">
      {/* Total Games */}
